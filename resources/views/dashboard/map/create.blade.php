...
@section('container')
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Buat Data Lokasi Baru</h1>
    </div>
        <form action="/dashboard/maps" method="POST" class="mb-5" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-lg-6">
            {{-- method form dibawah akan langsung diarahkan ke method store di controller || enctype digunakan agar dapat upload 2 data yaiitu teks dan gambar --}}
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('map_title') is-invalid @enderror" id="map_title" name="map_title" autofocus value="{{ old('map_title') }}">
                    {{-- Pesan Error --}}
                    @error('map_title')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('map_address') is-invalid @enderror" id="map_address" name="map_address" autofocus value="{{ old('map_address') }}">
                    {{-- Pesan Error --}}
                    @error('map_address')
                    <div class="invalid-feedback">
                        {{ $message }}
                ...
                {{-- <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('map_latitude') is-invalid @enderror" id="map_latitude" name="map_latitude" autofocus value="{{ old('map_latitude') }}">
                    @error('map_latitude')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('map_longitude') is-invalid @enderror" id="map_longitude" name="map_longitude" autofocus value="{{ old('map_longitude') }}">
                    @error('map_longitude')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="mb-3">
                    <label for="map_latitude" class="form-label">Latitude</label>
                    <input type="text" class="form-control @error('map_latitude') is-invalid @enderror"  name="map_latitude" id="map_latitude" autofocus>
                    @error('map_latitude')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="mb-3">
                    <label for="map_longitude" class="form-label">Longitude</label>
                    <input type="text" class="form-control @error('map_longitude') is-invalid @enderror"  name="map_longitude" id="map_longitude" autofocus>
                    @error('map_longitude')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="mb-3">
                    ...
                    @enderror
                    <input id="map_desc" type="hidden" name="map_desc">
                    <trix-editor input="map_desc"></trix-editor>
                </div>
                <div class="mb-3">
                    <label for="map_url" class="form-label">Website URL</label>
                    <input type="text" class="form-control" id="map_url" name="map_url" autofocus value="{{ old('map_url') }}">
                </div>
    
                <div class="mb-3">
                    <label for="map_postcode" class="form-label">Kode Pos</label>
                    <input type="text" class="form-control" id="map_postcode" name="map_postcode" autofocus value="{{ old('map_postcode') }}">
                </div>
                <div class="mb-3">
                    <label for="map_telp" class="form-label">Nomor Telpon</label>
                    <input type="text" class="form-control" id="map_telp" name="map_telp" autofocus value="{{ old('map_telp') }}">
                </div>
                <div class="mb-3">
                    <label for="map_email" class="form-label">Email</label>
                    <input type="text" class="form-control" id="map_email" name="map_email" autofocus value="{{ old('map_email') }}">
                </div>
                <div class="mb-3">
                    <label for="map_pimpinan" class="form-label">Nama Pimpinan</label>
                    <input type="text" class="form-control" id="map_pimpinan" name="map_pimpinan" autofocus value="{{ old('map_pimpinan') }}">
                </div>
            </div>
            <div class="col-lg-6">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="pend_waktu">
                        @if(old('pend_waktu') == '5 Hari Setiap Minggu')  
                        ...
                        @elseif(old('pend_waktu') == '6 Hari Setiap Minggu')
                            <option value = ''>Pilih Waktu Belajar</option>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="kes_igd" name="kes_igd" autofocus value="{{ old('kes_igd') }}">
                </div>
                <div class="mb-3">
                    <label for="kes_harilayanan" class="form-label">Jadwal Layanan (Kesehatan)</label>
                    <input type="text" class="form-control" id="kes_harilayanan" name="kes_harilayanan" autofocus value="{{ old('kes_harilayanan') }}">
                </div>
                <div class="mb-3">
                    <label for="kes_pasien" class="form-label">Jumlah Pasien (Kesehatan)</label>
                    <input type="text" class="form-control" id="kes_pasien" name="kes_pasien" autofocus value="{{ old('kes_pasien') }}">
                </div>
                <div class="mb-3">
                    <label for="perd_luas" class="form-label">Luas Tanah (Perdagangan)</label>
                    <input type="text" class="form-control" id="perd_luas" name="perd_luas" autofocus value="{{ old('perd_luas') }}">
                </div>
                <div class="mb-3">
                    <label for="perd_statustanah" class="form-label">Status Tanah (Perdagangan)</label>
                    <input type="text" class="form-control" id="perd_statustanah" name="perd_statustanah" autofocus value="{{ old('perd_statustanah') }}">
                </div>
                <div class="mb-3">
                    <label for="perd_haripasaran" class="form-label">Hari Pasaran (Perdagangan)</label>
                    <input type="text" class="form-control" id="perd_haripasaran" name="perd_haripasaran" autofocus value="{{ old('perd_haripasaran') }}">
                </div>
                <div class="mb-3">
                    <label for="perd_komoditas" class="form-label">Komoditas Perdagangan (Perdagangan)</label>
                    <input type="text" class="form-control" id="perd_komoditas" name="perd_komoditas" autofocus value="{{ old('perd_komoditas') }}">
                </div>
                <div class="mb-3">
                    <label for="perd_jmlkios" class="form-label">Jumlah Kios (Perdagangan)</label>
                    <input type="text" class="form-control" id="perd_jmlkios" name="perd_jmlkios" autofocus value="{{ old('perd_jmlkios') }}">
                </div>
                <div class="mb-3">
                    <label for="perd_jmlpedagang" class="form-label">Jumlah Pedagang (Perdagangan)</label>
                    <input type="text" class="form-control" id="perd_jmlpedagang" name="perd_jmlpedagang" autofocus value="{{ old('perd_jmlpedagang') }}">
                </div>
                <div class="mb-3">
                    <label for="sosmed_fb" class="form-label">Akun Facebook</label>
                    <input type="text" class="form-control" id="sosmed_fb" name="sosmed_fb" autofocus value="{{ old('sosmed_fb') }}">
                </div>
                <div class="mb-3">
                    <label for="sosmed_ig" class="form-label">Akun Instagram</label>
                    <input type="text" class="form-control" id="sosmed_ig" name="sosmed_ig" autofocus value="{{ old('sosmed_ig') }}">
                </div>
                <div class="mb-3">
                    <label for="sosmed_twit" class="form-label">Akun Twitter</label>
                    <input type="text" class="form-control" id="sosmed_twit" name="sosmed_twit" autofocus value="{{ old('sosmed_twit') }}">
                </div>
            </div>
            <div class="d-grid gap-2 col-4 mx-auto">
                <button type="submit" class="btn btn-primary">Create Data Lokasi</button>
            </div>
    ...
    <script>
        ...
        function initMap() {
                ...
                let lat_marker = -7.86302318;
                let long_marker = 110.150086;
