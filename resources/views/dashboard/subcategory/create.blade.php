...
@section('container')
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Buat Sub-Kategori Baru</h1>
    </div>
    <div class="col-lg-8">
        ...
        <form action="/dashboard/categoryChildren" method="POST" class="mb-5" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
                <label for="name" class="form-label">Nama Sub-Kategori</label>
                <input type="text" class="form-control @error('catchild_name') is-invalid @enderror" id="catchild_name" name="catchild_name" autofocus value="{{ old('catchild_name') }}">
                {{-- Pesan Error --}}
                @error('catchild_name')
